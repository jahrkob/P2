...
class MapPage(ctk.CTkFrame):
    ...
    def update_position(self,amr_ip:str,pos:tuple[float,float], name='robot'):
        """
        amr_ip:
        ...
        with self.__image_lock:
            ...
            self.amr_positions[amr_ip] = (pos[0],pos[1],self.__origin[0],self.__origin[1],self.__resolution)

            # make position relative to the canvas image
            # print(self.canvas.coords(self.__image_id))
            # map_coords = self.canvas.coords(self.__image_id)
            # if not map_coords:
            #     print('WARNING: map_coords not defined')
            #     return
    ...
    #         (round(self.image.width*self.factor), round(self.image.height*self.factor))
    #     )

    #     image = ImageTk.PhotoImage(self.resized)

    #     self.canvas.itemconfig(self.__image_id, image=image)
...
if __name__ == '__main__':
    def update_position_live(app:ctk.CTk, map_page:MapPage):
        for i in range(1000):
            app.after(0,)
            map_page.update_position('192.168.0.1', (-5.86+i/500,14.58-i/10))
            map_page.update_position('192.168.0.2', (-7.86+i/500,5.58+i/10))
            map_page.update_position('192.168.0.3', (-7.86+i/10,5.58+i/20))
            sleep(0.1)
    #test = ""
    
    class Testing(unittest.TestCase):
        @patch('requests.get')
        def test_get_working_map(self,mock_get):
            mock_response = Mock()
            mock_response.status_code = 200
            response_dict = {"guid": "7ecbf116-0d8e-11f1-b640-000129922d00", "session_id": "1a7b2063-0bed-11f1-8343-000129922d00", "name": "AAU SmartLab 2026_02", "base_map": "", "resolution": 0.05, "origin_x": -23.122, "origin_y": -11.061, "origin_theta": 0.0, "positions": "/v2.0.0/maps/7ecbf116-0d8e-11f1-b640-000129922d00/positions", "paths": "/v2.0.0/maps/7ecbf116-0d8e-11f1-b640-000129922d00/paths", "path_guides": "/v2.0.0/maps/7ecbf116-0d8e-11f1-b640-000129922d00/path_guides", "created_by_id": "mirconst-guid-0000-0004-users0000000", "created_by": "/v2.0.0/users/mirconst-guid-0000-0004-users0000000", "allowed_methods": ["PUT", "GET", "DELETE"], "created_by_name": "Distributor"}
            mock_response.json.return_value = response_dict
            ...
            network_monitorer = NetworkMonitorer('', auth_token=auth_token)

            map_page = MapPage(app, network_monitorer, testing=True, width=1000, height=720)
            ...
            map_page.pack_propagate(False)
            map_page.pack()

            map_update = Thread(target=update_position_live, args=(app, map_page), daemon=True)
