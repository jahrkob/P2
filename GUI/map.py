...
class MapPage(ctk.CTkFrame):
    def __init__(self, master, auth_token, base64_image=None, width = 200, height = 200, corner_radius = None, border_width = None, bg_color = "transparent", fg_color = None, border_color = None, background_corner_colors = None, overwrite_preferred_drawing_method = None, **kwargs):
    ...
    def update_amr_list(self):
        with app.app_context():
            self.__amr_list = db.session.query(AMRTable).all()
...
if __name__ == '__main__':
    ...
    class Testing(unittest.TestCase):
        ...
        def test_get_working_map(self,mock_get):
            ...
            map_page = MapPage(app, 'Basic ZGlzdHJpYnV0b3I6NjJmMmYwZjFlZmYxMGQzMTUyYzk1ZjZmMDU5NjU3NmU0ODJiYjhlNDQ4MDY0MzNmNGnmOTI5NzkyODM0YjAxNA==')
