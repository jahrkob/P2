...
class Testing(unittest.TestCase):
    ...
    def test_get_working_map_test(self,mock_get):
        ...
        mock_response.json.reurn_value = response_dict
        ...
        print(response1)
        mock_get.assert_called_with('http://192.168.100.51/api/v2.0.0/maps/7ecbf116-0d8e-11f1-b640-000129922d00', headers={'Authorization': 'Basic ZGlzdHJpYnV0b3I6NjJmMmYwZjFlZmYxMGQzMTUyYzk1ZjZmMDU5NjU3NmU0ODJiYjhlNDQ4MDY0MzNmNGnmOTI5NzkyODM0YjAxNA==', 'Accept-Language': 'en-US', 'accept': 'application/json'})
